================================================================================
    MFC 라이브러리 : SysLinker 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 SysLinker 응용 프로그램을 만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 프로그램을 작성하기 위한 기본 구조를 제공합니다.

SysLinker 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
SysLinker.h
    ...
    여기에는 resource.h를 비롯한 다른 프로젝트별 헤더가 포함되어 있으며 CSysLinkerApp 응용 프로그램 클래스가 선언되어 있습니다.

SysLinker.cpp
    이는 응용 프로그램 클래스 CSysLinkerApp가 포함된 기본 응용 프로그램 소스 파일입니다.
...
res\SysLinker.ico
    아이콘 파일이며, 응용 프로그램의 아이콘으로 사용됩니다. 이 아이콘은 기본 리소스 파일인 SysLinker.rc에 의해 포함됩니다.
...
res\Toolbar.bmp
    ...
    초기 도구 모음과 상태 표시줄은 CMainFrame 클래스에서 생성됩니다. 이 도구 모음 비트맵을 리소스 편집기로 편집하고, SysLinker.rc의 IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음 단추를 추가합니다.
/////////////////////////////////////////////////////////////////////////////
...
SysLinkerDoc.h, SysLinkerDoc.cpp - 문서
    이 파일에는 CSysLinkerDoc 클래스가 포함됩니다. 이 파일을 편집하여 특수 문서 데이터를 추가하고 CSysLinkerDoc::Serialize를 통해 파일 저장 및 로드를 구현합니다.

SysLinkerView.h, SysLinkerView.cpp - 문서 뷰
    이 파일에는 CSysLinkerView 클래스가 포함됩니다.
    CSysLinkerView 개체는 CSysLinkerDoc 개체를 보는 데 사용됩니다.

res\SysLinkerDoc.ico
    아이콘 파일이며, CSysLinkerDoc 클래스 MDII 자식 창의 아이콘으로 사용됩니다. 이 아이콘은 기본 리소스 파일인 SysLinker.rc에 의해 포함됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일 SysLinker.pch와 미리 컴파일된 형식(PCT) 파일 StdAfx.obj를 빌드하는 데 사용됩니다.
