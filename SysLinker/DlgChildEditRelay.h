...
class CDataDevice;
class CDlgChildEditRelay : public CDlgChildBasePage
{
	DECLARE_DYNAMIC(CDlgChildEditRelay)

public:
	CDlgChildEditRelay(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~CDlgChildEditRelay();

// 대화 상자 데이터입니다.
#ifdef AFX_DESIGN_TIME
#ifndef ENGLISH_MODE
	enum { IDD = IDD_DLG_CHILD_EDIT_RELAY };
#else
	enum { IDD = IDD_DLG_CHILD_EDIT_RELAY_EN };
#endif
#endif
