...
IMPLEMENT_DYNAMIC(CDlgInfoBasePage, CScrollDialog)

CDlgInfoBasePage::CDlgInfoBasePage(UINT nIDD,CWnd* pParent /*=NULL*/)
...
CDlgInfoBasePage::~CDlgInfoBasePage()
{
}

void CDlgInfoBasePage::DoDataExchange(CDataExchange* pDX)
{
	CScrollDialog::DoDataExchange(pDX);
}


BEGIN_MESSAGE_MAP(CDlgInfoBasePage, CScrollDialog)
END_MESSAGE_MAP()


// CDlgInfoBasePage 메시지 처리기입니다.

BOOL CDlgInfoBasePage::GetIDNum(ST_TREEITEM* pTreeItem, int &nFid, int &nUid, int &nCid, int &nDevid
...
int CDlgInfoBasePage::IsSameAddress(ST_TREEITEM * pCurData, ST_TREEITEM * pNewData)
{
