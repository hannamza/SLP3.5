...
public:
	...
	void SetHeaderColor(BOOL b3D, COLORREF crHeader) { m_b3DHeader = b3D; m_crHeader = crHeader; }
	void SetDefaultFont(CString strName, int nFontSize) { m_strFontName = strName; m_nFontSize = nFontSize; }
// Overrides
public:
...
protected:
	...
	// [KHS 2017-4-13 14:41:34] 
	// 
	COLORREF m_crHeader;
	BOOL		m_b3DHeader;

	BOOL		m_bBold;
	CString		m_strFontName;// "" 일때 기본 폰트
	int			m_nFontSize; // -1일때 기본 폰트 크기
